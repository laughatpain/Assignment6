...
extends AnimatedActor
{
    ...
    public Jesse(String name, Point position, int rate, int resourceDistance, int animationRate,
                 List<PImage> imgs)
    {
    ...
    {
        Meowth meowth = new Meowth(name, pt, 500, 100, imageStore.get("meowth"),world);
